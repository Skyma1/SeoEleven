...
export const FORM_SERVICES = [
  ...
  // Разработка подуслуги
  'Веб-разработка',
  // Автоматизация подуслуги
...
export const SERVICES_REQUIRING_WEBSITE = [
  ...
  'SEO-аудит (классический)',
  'SEO для маркетплейсов (WB, Ozon)',
  // Аналитика подуслуги, требующие сайт
  'Аналитика и аудит',
  'Настройка аналитики',
];
...
export const SERVICE_MAPPING = {
  ...
  'GEO / AI SEO': 'GEO / AI SEO',
  'Комплексное SEO-продвижение': 'SEO-продвижение',
  'SEO-продвижение': 'SEO-продвижение',
  'Продвижение молодых сайтов': 'SEO-продвижение',
  'Базовая оптимизация и мета-теги': 'SEO-продвижение',
  'Статейное продвижение': 'SEO-продвижение',
  'Сбор семантического ядра': 'SEO-продвижение',
  'Ссылочное продвижение': 'SEO-продвижение',
  'Продвижение по словам': 'SEO-продвижение',
  'SEO-аудит (классический)': 'Аудит / аналитика',
  'SEO для маркетплейсов (WB, Ozon)': 'SEO-продвижение',
  
  // Реклама
  'Контекстная реклама': 'Контекстная реклама',
  'Таргетированная реклама': 'Контекстная реклама',
  'Настройка Яндекс.Директ': 'Контекстная реклама',
  ...
  'Поддержка и обслуживание': 'Поддержка / доработка',
  
  // Автоматизация
  'Telegram bots & Mini Apps': 'Автоматизация / боты',
  'Telegram-боты и Mini Apps': 'Автоматизация / боты',
  'No-code automation': 'Автоматизация / боты',
  'Автоматизация без кода (Make, n8n)': 'Автоматизация / боты',
  'Индивидуальные скрипты': 'Автоматизация / боты',
  
  // Аналитика
  'Advanced analytics & audit': 'Аудит / аналитика',
  'Аналитика и аудит': 'Аудит / аналитика',
  'Настройка аналитики': 'Аудит / аналитика',
  
  // Другое
  'Настройка хостинга': 'Поддержка / доработка',
